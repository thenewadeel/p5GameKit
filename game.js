...
class Rocket {
  ...
  show() {
    ...
    text("Velocity: " + this.vel.mag(), midX / 10, 50);
    text("Heading: " + Math.floor(this.vel.heading()), midX / 10, 70);
    text("Thruster: " + this.thrusterState, midX / 10, 90);
    text("Pos: " + Math.floor(this.pos.x)+", " + Math.floor(this.pos.y), midX / 10, 110);
  }
}
